...
void main() {
  ...
  group('IntoleranceHelpers.triggersFor', () {
    test('Fruktose returns fructoseTriggers', () {
      expect(
        IntoleranceHelpers.triggersFor('Fruktose', profile),
        ['Apfel', 'Birne'],
      );
    });
    ...
    test('Laktose returns lactoseTriggers', () {
      expect(
        IntoleranceHelpers.triggersFor('Laktose', profile),
        ['Milch'],
      );
    });
    ...
    test('Histamin returns histaminTriggers', () {
      expect(
        IntoleranceHelpers.triggersFor('Histamin', profile),
        ['Tomate', 'Spinat'],
      );
    });
    ...
    test('unknown intolerance returns empty list', () {
      expect(
        IntoleranceHelpers.triggersFor('Unknown', profile),
        isEmpty,
      );
    });
  });
